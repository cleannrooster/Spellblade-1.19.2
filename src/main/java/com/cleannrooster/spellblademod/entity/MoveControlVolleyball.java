...
public class MoveControlVolleyball implements Control {
    public MoveControlVolleyball(Mob p_24983_) {
        this.mob = p_24983_;
    }
    ...
    protected MoveControlVolleyball.Operation operation = MoveControlVolleyball.Operation.WAIT;


    public boolean hasWanted() {
        return this.operation == MoveControlVolleyball.Operation.MOVE_TO;
    }
    ...
    public void setWantedPosition(double p_24984_, double p_24985_, double p_24986_, double p_24987_) {
        ...
        if (this.operation != MoveControlVolleyball.Operation.JUMPING) {
            this.operation = MoveControlVolleyball.Operation.MOVE_TO;
        }

    }

    public void strafe(float p_24989_, float p_24990_) {
        this.operation = MoveControlVolleyball.Operation.STRAFE;
        ...
        public void tick() {
            if (this.operation == MoveControlVolleyball.Operation.STRAFE) {
                ...
                if (this.mob.horizontalCollision) {
                    ...
                    this.operation = MoveControlVolleyball.Operation.JUMPING;
                }
                this.mob.setSpeed(f1);
                this.mob.setZza(this.strafeForwards);
                this.mob.setXxa(this.strafeRight);
                this.operation = MoveControlVolleyball.Operation.WAIT;
            } else if (this.operation == MoveControlVolleyball.Operation.MOVE_TO) {
                this.operation = MoveControlVolleyball.Operation.WAIT;
            ...
            } else if (this.operation == MoveControlVolleyball.Operation.JUMPING) {
                    this.mob.setSpeed(this.strafeForwards);
                    this.mob.setZza(this.strafeForwards);
                this.mob.setXxa(this.strafeRight);
